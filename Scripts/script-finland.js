...
async function fetchData() {
  ...
  try {
    const response = await fetch("../db/finland/finland/spiders/finland-data.json");
    ...
    const finlandParties = Object.values(partiesData.finland[0]);
    ...
    filteredData.forEach((row, index) => {
      const value = finlandParties[index] || "-";
